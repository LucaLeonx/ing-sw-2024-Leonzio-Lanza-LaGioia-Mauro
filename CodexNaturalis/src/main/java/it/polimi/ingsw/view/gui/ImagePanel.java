...
public class ImagePanel extends JPanel {
    ...
    public ImagePanel(String imageNumber) {
        this.frontPanel = new FrontPanel(Toolkit.getDefaultToolkit().getImage("CodexNaturalis/src/main/resources/front_images/" + imageNumber + ".jpeg"));
        this.backPanel = new BackPanel(Toolkit.getDefaultToolkit().getImage("CodexNaturalis/src/main/resources/back_images/" + imageNumber + ".jpeg"));
